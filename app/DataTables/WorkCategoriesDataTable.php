...
class WorkCategoriesDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
            ...
            ->addColumn('action', function($data){
                ...
                $html .= '<a href="'.route("workcategories.edit",  $data->id).'" class="btn btn-primary m-1"><i class="fa fa-edit"></i></a>';
                return $html;
    ...
    {
        return $this->builder()
                    ->setTableId('work-categories-table')
    ...
    {
        return 'WorkCategories_' . date('YmdHis');
    }
}
