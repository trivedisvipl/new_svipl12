...
class SliderDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
            ...
            ->addColumn('image', function($data){
                $photo = SLIDER_IMAGE;
                if($data->image){
                    if (File::exists(SLIDER_IMAGE_PATH.$data->image) ) {
                        $photo = SLIDER_IMAGE_ROOT.$data->image;
                    }
                }
                return '<img src="'.$photo.'" alt="Slider img" class="datatable-img">';
            })
            ...
            ->addColumn('action', function($data){
                ...
                $html .= '<a href="'.route("slider.edit",  $data->id).'" class="btn btn-primary m-1"><i class="fa fa-edit"></i></a>';
                return $html;
