...
class TeamDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
            ...
            ->addColumn('image', function($data){
                $photo = TEAM_IMAGE;
                if($data->image){
                    if (File::exists(TEAM_IMAGE_PATH.$data->image) ) {
                        $photo = TEAM_IMAGE_ROOT.$data->image;
                    }
                }
                return '<img src="'.$photo.'" alt="team img" class="datatable-img">';
            })
            ...
            ->addColumn('action', function($data){
                ...
                $html .= '<a href="'.route("team.edit",  $data->id).'" class="btn btn-primary m-1"><i class="fa fa-edit"></i></a>';
                return $html;
