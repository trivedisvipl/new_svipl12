...
@section('content')
  ...
  <div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">Our Blog</h4>
        <!-- Ajax Sourced Server-side -->
        <div class="card">
            <div class ="row card-header">
                <div class ="col-md-8">
                  <h5 class="align-middle">Blog List</h5>
                </div>
                <div class ="col-md-4">
                  <a class="btn btn-success float-end" href="{!! route('blog.create') !!}">ADD</a>
                </div>
              </div>
              <div class="card-body">
