    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class ="row card-header">
                <div class ="col-md-8">
                  <h5 class="align-middle">Blog Category List</h5>
                </div>
                <div class ="col-md-4">
                  <a class="btn btn-success float-end" href="{!! route('blogcategories.create') !!}">ADD</a>
                </div>
              </div>
              <div class="card-body">
...
$.ajax({
    type: "POST",
    url: "/{!! ADMIN_SLUG !!}/blogcategories/" + id,
    data: {
        _method: 'DELETE',
        _token: "{!! csrf_token() !!}"
    },
    ...
    success: function(resp) {
        ...
        window.LaravelDataTables["blog-categories-table"].draw();
    },
    error: function(e) {
        alert('Error: ' + e);
    }
...
$.ajax({
    type: "POST",
    url: '{{ route("blogcategories.changeStatus") }}',
    datatype: "json",
    data: {
        '_token': '{!! csrf_token() !!}',
        'id':id,
