...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Team Page </h4>
      <div class="row mb-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
                @include('admin.includes.notifications')
                   ...
                   {!! html()->modelForm($team, 'POST', route('setting.team.store'))
                    ->id('team-form')
                ...
                <div class="mb-3">
                    @if(isset($team) && !empty($team))
                        @if(array_key_exists("meta_image", $team) && file_exists(SETTING_IMAGE_PATH.$team['meta_image']))
                            <img src="{!! SETTING_IMAGE_ROOT.$team['meta_image'] !!}" style="height: 100px;" class="mt-2">
                        @else
                            No Image Found
                        @endif
                    @endif
