...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: linear-gradient(133deg, #FF8A00 -0.78%, #FAFF00 49.68%, #FF8A00 100.15%);
        }
        .wrapper {
            display: grid;
        ...
        .wrapper .container .text article .back-btn {
            padding: 15px 30px;
            font-size: 20px;
            border-radius: 30px;
            display: flex;
            justify-content: center;
            align-items: center;
            background: linear-gradient(90deg, #002871 0%, #004CD7 100%);
            color:#fff;
            box-shadow: 0px 15px 20px rgba(54, 24, 79, 0.5);
            transition: background 1000ms ease-in-out 0s ;
        }
        .wrapper .container .text article .back-btn:hover {
            box-shadow: 0px 15px 20px rgba(54, 24, 79, 0.5);
            background: linear-gradient(90deg, #06292F 0%, #138295 100%);
            transition:background 1000ms ease-in-out 0s ;
            color: white;
        }
        ...
        .wrapper .container .circle:before {
            ...
            left: 50%;
            transform: translate(-50%, -50%);
            box-shadow: inset 5px 20px 40px #FF5722, inset 5px 0px 5px rgb(255 206 59), inset 5px 5px 20px #FF9800, 2px 2px 5px #FFEB3B;;
        ...
        .wrapper .container .one .content:before {
            ...
            width: 600px;
            height: 600px;
            background-color: rgb(115 96 63 / 20%);
            border-radius: 100%;
            box-shadow: inset 5px 20px 40px #FF5722, inset 5px 0px 5px #FF9800, inset 5px 5px 20px #FFC107, 2px 2px 5px #FFEB3B;
        ...
        .wrapper .container .two .content .piece {
            background: linear-gradient(270deg, #9747FF 0%, #5B2B99 100%);
        }
        ...
        <div class="container">
            ...
            <div class="text">
                <article>
                    ...
                    <a href="{!! route('home') !!}" class="back-btn" role="button" type="button">Go Back </a>
                </article>
            </div>
