    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class ="row card-header">
                <div class ="col-md-8">
                  <h5 class="align-middle">Slider List</h5>
                </div>
                <div class ="col-md-4">
                  <a class="btn btn-success float-end" href="{!! route('slider.create') !!}">ADD</a>
                </div>
              </div>
              <div class="card-body">
...
$.ajax({
    ...
    success: function(resp) {
        ...
        window.LaravelDataTables["slider-table"].draw();
    },
    error: function(e) {
        alert('Error: ' + e);
    }
