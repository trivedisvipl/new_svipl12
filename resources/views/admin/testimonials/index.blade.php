...
@section('content')
  ...
  <div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">Client says</h4>
        <!-- Ajax Sourced Server-side -->
        <div class="card">
            <div class ="row card-header">
                <div class ="col-md-8">
                  <h5 class="align-middle">Client says List</h5>
                </div>
                <div class ="col-md-4">
                  <a class="btn btn-success float-end" href="{!! route('testimonials.create') !!}">ADD</a>
                </div>
              </div>
              <div class="card-body">
...
$.ajax({
    type: "POST",
    url: "/{!! ADMIN_SLUG !!}/testimonials/" + id,
    data: {
        _method: 'DELETE',
        _token: "{!! csrf_token() !!}"
    },
    ...
    success: function(resp) {
        ...
        window.LaravelDataTables["testimonials-table"].draw();
    },
    error: function(e) {
        alert('Error: ' + e);
    }
...
$.ajax({
    type: "POST",
    url: '{{ route("testimonials.changeStatus") }}',
    datatype: "json",
    data: {
        '_token': '{!! csrf_token() !!}',
        'id':id,
