...
<body>
    <div style="width:600px; margin:0 auto; font-family:Arial, Helvetica, sans-serif;">
        ...
        <header
            ...
            <a href="#"><img style="width: 70px;" src="{!! asset('assets/frontend/images/header_logo.png') !!}"></a>
        ...
        <div style="text-align:center; background-color:#f1f1f1; padding-top: 15px; padding-bottom: 10px;">
            <a href="#" style="width: 100%; display: block;"><img src="{!! asset('assets/frontend/images/header_logo.png') !!}" style="width:40px; margin: auto; display: block;"></a>
